 ...
 */
package com.datavim.chatapp.utils.parser;
...
public class Parser {
    ...
    public TextMarkdown parse(@NonNull final String string) {
        ...
        while (matcher.find(lastStartIndex)) {
            ...
            parents.add(new Element(Element.Type.QUOTE, quotedText, Collections.<Element>emptyList()));
        }
        ...
        while (matcher.find(lastStartIndex)) {
            ...
            switch (mark) {
                ...
                case BULLET_STAR:
                    ...
                    Element bulletPoint = new Element(Element.Type.BULLET_POINT, text, subMarks);
                ...
                case CODE_BLOCK:
                    ...
                    if (markEnd == -1) {
                        ...
                        parents.add(new Element(Element.Type.TEXT, text, Collections.<Element>emptyList()));
                        lastStartIndex = markEnd;
                    } else {
                        // we found the end of the code block
                        text = string.substring(endIndex, markEnd);
                        parents.add(new Element(Element.Type.CODE_BLOCK, text,
